...
stage=-1
# diffenent stop_stage 
# -1 数据下载                0 数据准备                1 提取说话人嵌入特征
#  2 提取离散语音 token      3 准备 Parquet 格式数据    4 推理
#  5 训练                   6 模型平均                 7 模型导出
stop_stage=3
...
pretrained_model_dir=/root/.cache/huggingface/zzl/models/cosyvoice/pretrained_models/CosyVoice2-0.5B
